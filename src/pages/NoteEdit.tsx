...
const NoteEdit = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    updateNote(id!, { title: title.trim(), content: content.trim(), tags });
    navigate(`/notes/${id}`);
  };
    ...
    <Layout>
      <div className="mx-auto max-w-2xl animate-fade-in">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold">Editar nota</h1>
            <p className="text-sm text-muted-foreground">Modifica el contenido de tu nota</p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-card p-6 shadow-md-custom">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Textarea id="content" value={content} onChange={(e) => setContent(e.target.value)} rows={10} className="resize-none leading-relaxed" />
            </div>
            <div className="space-y-2">
